  ...
  //public static final int MSQL_ERR_UNKNOWN_COLUMN     =     ?;  // does not appear to be supported by MSQL 
    ...
    **/
    private boolean _loadInsertRecord(String oldFieldNames[], String rowValues[], 
        InsertionValidator validator, boolean insertRecord, boolean overwriteExisting)
        throws DBException, SQLException, IOException
    {

        /* row values InsertionValidator */
        ...
        if (dbRcdKey.exists()) {
            ...
            /* record update InsertionValidator */
            if ((validator != null) && !validator.validateUpdate(dbRcd,fieldNameList)) {
            ...
            /* record insert InsertionValidator */
            if ((validator != null) && !validator.validateInsert(dbRcd)) {
    ...
    **/
    ...
    {
        // -- set fields on which this InsertionValidator operates
        ...
        public boolean validateUpdate(DBRecord dbr, Set<String> fieldNameList) throws DBException;
