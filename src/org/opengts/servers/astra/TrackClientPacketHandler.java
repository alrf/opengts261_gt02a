    ...
    extends AbstractClientPacketHandler
{
    ...
    private boolean parseInsertRecord_C(byte pktBytes[])
    {
        ...
        double altitude;
        double journeyDist;
        double odometer = 0.0; // parseInsertRecord_C
        double adc1;
        double adc2;
        double extPwr;
        GeoPoint geoPoint;
        ...
        this.device = DCServerFactory._loadDeviceByPrefixedModemID(UNIQUEID_PREFIX, imei); // parseInsertRecord_C
        ...
        do
        {
            ...
            /* add estimated odometer calculation [2.6.1-B03] */
            if (odometer <= 0.0) {
                odometer = (ESTIMATE_ODOMETER && validGPS)? 
                    this.device.getNextOdometerKM(geoPoint) : 
                    this.device.getLastOdometerKM();
            } else {
                odometer = this.device.adjustOdometerKM(odometer);
            }
            ...
            /* Insert record into EventData table [parseInsertRecord_C] */
    ...
    private boolean parseInsertRecord_K(byte pktBytes[])
    {
        ...
        double altitude;
        double journeyDist;
        double odometer; // parseInsertRecord_K
        double adc1;
        double extPwr;
        GeoPoint geoPoint;
        boolean reportsToFollow = false;
    ...
    private boolean parseInsertRecord_M(byte pktBytes[])
    {
        ...
        double altitude;
        double journeyDist;
        double odometer; // parseInsertRecord_M
        double adc1;
        double adc2;
        double extPwr;
        GeoPoint geoPoint;
        ...
        /* Find the device in the database */
        this.device = DCServerFactory._loadDeviceByPrefixedModemID(UNIQUEID_PREFIX, imei); // parseInsertRecord_M
        //this.device = DCServerConfig.loadDeviceUniqueID(Main.getServerConfig(), imei);
        if (this.device == null)
        {
            /* Error already logged */
        ...
        do
        {
            ...
            /* Insert record into EventData table [parseInsertRecord_M] */
            insertEventRecord(this.device, 
                    fixtime, statusCode, geoPoint,
                    speed, heading, altitude,
                    journeyDist, odometer, rawData);
    ...
    private boolean parseInsertRecord_V(byte pktBytes[])
    {
        ...
        double altitude;
        double journeyDist;
        double odometer; // parseInsertRecord_V
        double adc1;
        double adc2;
        double extPwr;
        GeoPoint geoPoint;
        ...
        /* Find the device in the database */
        this.device = DCServerFactory._loadDeviceByPrefixedModemID(UNIQUEID_PREFIX, imei); // parseInsertRecord_V
        //this.device = DCServerConfig.loadDeviceUniqueID(Main.getServerConfig(), imei);
        if (this.device == null)
        {
            /* Error already logged */
        ...
        do
        {
            ...
            /* Insert record into EventData table [parseInsertRecord_V] */
