        ...
        implements DBFactory.InsertionValidator
    {
        ...
        public boolean validateValues(String v[]) throws DBException {
            ...
            // -- valid accountID
            {
                ...
                if (this.accountID_ndx >= 0) {
                    if (this.filterIDs) {
                        a = AccountRecord.getFilteredID(v[this.accountID_ndx],false/*noNull*/,true/*lowerCase*/);
            ...
            // -- valid geozoneID
            {
                ...
                if (this.geozoneID_ndx >= 0) {
                    if (this.filterIDs) {
                        z = AccountRecord.getFilteredID(v[this.geozoneID_ndx],false/*noNull*/,true/*lowerCase*/);
