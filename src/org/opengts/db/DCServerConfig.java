    ...
    implements Comparable
{
  ...
  //public static final String  COMMAND_OUTPUT                  = "output";     // arg=gpioOutputState
    ...
    *** @return The FuelLevelProfile
    **/
    public FuelLevelProfile getFuelLevelProfile(Device dev, int tankNdx, FuelLevelProfile dft)
    {
        if (dev != null) {
    ...
    *** @param dev      The Device instance
    *** @param tankNdx  The fuel-tank index (#1 or #2)
    ...
    **/
    public double getActualFuelLevel(Device dev, int tankNdx, double preLevel, FuelLevelProfile dft)
    {

        /* try device custom FuelLevelProfile */
        if ((dev != null) && dev.hasFuelTankProfile(tankNdx)) {
            // -- convert using device FuelTankProfile [calls dev.getFuelLevelProfile(...)]
            Print.logDebug("Applying Device custom FuelLevelProfile: " + dev.getFuelTankProfile(tankNdx));
            return dev.getActualFuelLevel(tankNdx, preLevel); // %
        }

        /* config defined FuelLevelProfile */
        FuelLevelProfile flp = this.getFuelLevelProfile(dev, tankNdx, dft);
        if (flp != null) {
    ...
    *** @return The converted fuel-level.  Will return the pre-converted-level if a FuelLevelProfile is not defined.
    **/
    public double getActualFuelLevel(Device dev, int tankNdx, double preLevel)
    {
        return this.getActualFuelLevel(dev, tankNdx, preLevel, null/*FuelLevelProfile*/);
    }
    ...
    *** @return The converted fuel-level.  Will return the pre-converted-level if a FuelLevelProfile is not defined.
    **/
    public static double getActualFuelLevel(DCServerConfig dcs, Device dev, int tankNdx, double preLevel, FuelLevelProfile dft)
    {
        if (dcs != null) {
            return dcs.getActualFuelLevel(dev, tankNdx, preLevel, dft);
        } else
        if (dft != null) {
    ...
    *** @return The converted fuel-level.  Will return the pre-converted-level if a FuelLevelProfile is not defined.
    **/
    public static double getActualFuelLevel(DCServerConfig dcs, Device dev, int tankNdx, double preLevel)
    {
        return DCServerConfig.getActualFuelLevel(dcs, dev, tankNdx, preLevel, null/*FuelLevelProfile*/);
    }
