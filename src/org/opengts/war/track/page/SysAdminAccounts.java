    ...
    implements Constants
{
    ...
    public  static final String PARM_ACCT_ENABLE_ELOG           = "a_elog";
        ...
        throws IOException
    {
        ...
        final boolean  showEnableDriverELogs = 
            privLabel.getBooleanProperty(PrivateLabel.PROP_SysAdminAccounts_showEnableDriverELogs,false);
        ...
        */
        ...
        if (updateAccount) {
            if (selAccount == null) {
                ...
                String  elogEnableStr = AttributeTools.getRequestString(request, PARM_ACCT_ENABLE_ELOG   , "");
                User    adminUser     = null;
                listAccounts = true;
                // -- sms default enabled?
              ...
              //String menuURL    = EncodeMakeURL(reqState,RequestProperties.TRACK_BASE_URI(),PAGE_MENU_TOP);
                ...
                if (_listAccounts) {
                    ...
                    if (showEnableDriverELogs && isSysAdmin) {
                        ...
                        out.println(FormRow_ComboBox(PARM_ACCT_ENABLE_ELOG, editSysAdmin, i18n.getString("SysAdminAccounts.enableDriverELogs","Enable Driver ELogs")+":", elogOpt, elogMap, "", -1, elogDesc));
                    }
