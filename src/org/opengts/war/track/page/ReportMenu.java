    ...
    implements Constants
{
    ...
    /* ACL */
    public  static final String _ACL_NON_HTML_FORMAT            = "nonHtml";
    ...
    **/
        ...
        throws IOException
    {
        ...
        /* html only? */
        final boolean allowNonHtmlFormat = privLabel.hasWriteAccess(currUser, this.getAclName());

        /* has CSV support */
        final boolean hasCSVSupport = allowNonHtmlFormat && true;

        /* has XML support */
        final boolean hasXMLSupport = allowNonHtmlFormat && true;

        /* has PDF support */
        final boolean hasPDFSupport = allowNonHtmlFormat && false; // TODO: not yet supported

        /* has XLS/XLSX support */
        final boolean hasXLSSupport = allowNonHtmlFormat && ReportSpreadsheet.IsExcelSpreadsheetSupported();
        ...
        if (!EMail.isSendMailEnabled()) {
            ...
            // -- otherwise enabled
            hasEmailSupport = allowNonHtmlFormat && true; // StringTools.isBlank(toEmailAddress);
        }
        ...
        if (!privLabel.getBooleanProperty(PrivateLabel.PROP_ReportMenu_enableReportSchedule,false)) {
            ...
            hasSchedule = allowNonHtmlFormat && true; // EXPERIMENTAL (may not be fully supported)
        }
        ...
        final boolean hasCustomURL       = allowNonHtmlFormat && !StringTools.isBlank(privLabel.getStringProperty(PrivateLabel.PROP_ReportMenu_customFormatURL,""));
