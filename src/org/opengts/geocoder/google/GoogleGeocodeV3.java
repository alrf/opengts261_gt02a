    ...
    implements ReverseGeocodeProvider, GeocodeProvider
{
    ...
    protected static final String  PROP_failTMO_default         = PROP_failoverTimeout_ + "default";        //    0
    protected static final String  PROP_failTMO_overQuerLimit   = PROP_failoverTimeout_ + "overQueryLimit"; //   60
    protected static final String  PROP_failTMO_limitExceeded   = PROP_failoverTimeout_ + "limitExceeded";  // 1800
    protected static final String  PROP_failTMO_requestDenied   = PROP_failoverTimeout_ + "requestDenied";  // 3600
    protected static final String  PROP_failTMO_invalidRequest  = PROP_failoverTimeout_ + "invalidRequest"; // 7200
    protected static final String  PROP_failTMO_notAuthorized   = PROP_failoverTimeout_ + "notAuthorized";  //  300
    protected static final String  PROP_failTMO_unknown         = PROP_failoverTimeout_ + "unknown";
